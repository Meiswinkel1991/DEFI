...
export default function Home() {
    ...
    const getAmounts = async () => {
        try {
            ...
            //get the amount of tokens in the user's account
            ...
            const _etherBalanceContract = await getEtherBalance(
                provider,
                null,
                true
            )
    ...
    const _addLiquidity = async () => {
        try {
            ...
            if (!addCDTokens.eq(zero) && !addEtherWei.eq(zero)) {
                ...
                setAddCDTokens(zero)
                //Get amount for all values after liquidity has been addet
                await getAmounts()
            } else {
                setAddCDTokens(zero)
            }
