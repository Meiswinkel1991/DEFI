...
error Exchange__TokenAddressIsNullAddress();
error Exchange__AmountIsNotEnough();
error Exchange__InvalidReserve();
error Exchange__InsuffientOutputAmount();
...
contract Exchange is ERC20 {
    ...
    constructor(address _CryptoDevToken) ERC20("CryptoDev LP Token", "CDLP") {
        if (_CryptoDevToken == address(0)) {
            revert Exchange__TokenAddressIsNullAddress();
        }
    ...
    */
        ...
        */
            ...
            if (_amount < cryptoDevTokenAmount) {
                revert Exchange__AmountIsNotEnough();
            }
    ...
    function ethToCryptoDevToken(uint _minTokens) public payable {
        ...
        if (tokensBought < _minTokens) {
            revert Exchange__InsuffientOutputAmount();
        }
    ...
    function getAmountOfTokens(
        ...
        uint256 denumerator = (inputReserve * 100) + inputAmountWithFee;
